...
public class BookingNotificationService {
    ...
    private final ChannelTopic bookingNotificationsTopic;
    private final ObjectMapper objectMapper;

    public BookingNotificationService(
            @Qualifier("customRedisTemplate") RedisTemplate<String, Object> redisTemplate,
            @Qualifier("bookingNotificationsTopic") ChannelTopic bookingNotificationsTopic,
            ObjectMapper objectMapper) {
        this.redisTemplate = redisTemplate;
        this.bookingNotificationsTopic = bookingNotificationsTopic;
    ...
    private void publishMessage(Map<String, Object> message) {
        try {
            ...
            redisTemplate.convertAndSend(bookingNotificationsTopic.getTopic(), jsonMessage);

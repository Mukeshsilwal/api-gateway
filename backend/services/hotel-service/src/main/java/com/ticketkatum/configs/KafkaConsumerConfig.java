...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, PaymentVerifiedEvent> consumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PaymentVerifiedEvent> kafkaListenerContainerFactory() {

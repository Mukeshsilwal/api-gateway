...
public class EventAggregatorService {
        ...
        return eventServiceClient.getEvent(eventId)
                .map(response -> {
                    try {
                        ...
                        Map<String, Object> eventData = (Map<String, Object>) response.getData();

                        return buildAggregatedEvent(eventData);
                    } catch (Exception e) {
    ...
    public Mono<List<AggregatedEventDto>> searchAggregatedEvents(Map<String, Object> searchParams) {
        ...
        return eventServiceClient.searchEvents(searchParams)
                .map(response -> {
                    try {
                        @SuppressWarnings("unchecked")
                        List<Map<String, Object>> events = (List<Map<String, Object>>) response.getData();
    ...
    private AggregatedEventDto buildAggregatedEvent(Map<String, Object> eventData) {
        @SuppressWarnings("unchecked")

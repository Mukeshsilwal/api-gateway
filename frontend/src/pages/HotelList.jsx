...
const HotelList = () => {
    ...
    const fetchHotels = useCallback(async () => {
        ...
        try {
            ...
            let finalResult = Array.isArray(result) ? result : result.hotels || [];
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600">
                            {defaultParams.checkInDate && defaultParams.checkOutDate && (
                                `${defaultParams.checkInDate} - ${defaultParams.checkOutDate} • ${defaultParams.guests} Guest${defaultParams.guests > 1 ? 's' : ''}`
                            )}
                        </p>
                    </div>

...
import { Calendar, MapPin, User, Mail, Phone, CreditCard, ArrowLeft, CheckCircle } from 'lucide-react';
...
export function EventBooking() {
    ...
    const [selectedPaymentGateway, setSelectedPaymentGateway] = useState('ESEWA');
                                    ...
                                    return (
                                        <div key={ticketTypeId} className="flex justify-between text-sm">
                                            ...
                                            <span className="font-semibold">
                                                NPR {(ticket.price * quantity).toLocaleString()}
                                            </span>
                                        </div>
                                    );
                                })}

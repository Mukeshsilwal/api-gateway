...
import { Calendar, MapPin, Clock, Users, Share2, Heart, AlertCircle, CheckCircle } from 'lucide-react';
...
export function EventDetails() {
    ...
    const handleTicketQuantityChange = (ticketTypeId, change) => {
        ...
        const newQuantity = Math.max(0, Math.min(currentQuantity + change, ticket.quantity - (ticket.quantitySold || 0)));

...
import { User, Mail, Phone, MapPin, Calendar, Clock, ShieldCheck } from "lucide-react";
...
export default function TicketDetails() {
    ...
    const [selectedBus, setSelectedBus] = useState<Bus>(initialBus || {});
    ...
    useEffect(() => {
        const fetchDetails = async () => {
            if (initialBus?.id) {
                try {
                    const busService = (await import("../services/busService")).default;
                    const completeInfo = await busService.getBusCompleteDetails(initialBus.id);

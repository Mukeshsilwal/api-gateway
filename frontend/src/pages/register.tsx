...
const FileUploadField: React.FC<FileUploadFieldProps> = ({ id, label, error, touched, onChange, value }) => (
...
const InputField: React.FC<InputFieldProps> = ({ id, label, icon: Icon, error, touched, ...props }) => (
    <div>

...
const PlaneList = () => {
    ...
    const [filters, setFilters] = useState<PlaneListFilters>({
        maxPrice: "",
        airline: "",
    });
    ...
    useEffect(() => {
        ...
        const storedSearch = localStorage.getItem("planeSearchDetails");
        const searchDetails = storedSearch ? JSON.parse(storedSearch) : null;

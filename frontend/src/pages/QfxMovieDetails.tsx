...
const QfxMovieDetails = () => {
    ...
    const [showtimes, setShowtimes] = useState<{ [key: string | number]: Showtime[] }>({});
    ...
    useEffect(() => {
        const fetchShowtimes = async () => {
            if (!movie || cinemas.length === 0 || !id) return;

            const showtimesMap: { [key: string | number]: Showtime[] } = {};
    ...
    const handleShowtimeClick = (showtimeId: string | number) => {
            ...
            <div className="bg-gray-900 text-white min-h-screen">
                ...
                <div className="relative h-[50vh] sm:h-[60vh]">
                    <div className="absolute inset-0">
                        <img
                            src={movie.PosterUrl || 'https://placehold.co/1200x600?text=No+Backdrop'}
                            alt={movie.MovieName}

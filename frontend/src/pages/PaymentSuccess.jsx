...
import { CheckCircle, Download, Home, Receipt, AlertCircle } from 'lucide-react';
...
export default function PaymentSuccess() {
    ...
    // State
    const [status, setStatus] = useState('VERIFYING'); // VERIFYING, SUCCEEDED, FAILED
    ...
    useEffect(() => {
        const handleSuccess = async () => {
            ...
            if (txnId && txnId.includes('?')) {
                ...
                // We should clean it.
                // Example: TXN-123?data=...
                // But wait, searchParams.get('txnId') usually stops at & but if ? is there it might include it.
                // Let's split by ? just in case.
                // This effectively cleans "TXN...?data=..." to just "TXN..."
            }
            ...
            try {
                ...
                // Service throws error if request fails, so we don't need to check response.ok manually here.
                // const result is already the data.

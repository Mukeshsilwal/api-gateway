        ...
        <div className="min-h-screen bg-background text-foreground">
            ...
            <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-background">
                ...
                <div className="absolute inset-0 bg-background">
                    <div className="absolute top-20 right-20 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl opacity-50 dark:opacity-100"></div>
                ...
                <div className="container mx-auto px-4 py-20 relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="text-gray-900 dark:text-white space-y-8 animate-slide-up">
                            ...
                            <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-2xl border-l-4 border-purple-500 pl-6">
                            ...
                            <div className="flex gap-4 pt-4">
                                <button
                                    ...
                                    className="px-8 py-4 bg-gradient-to-r from-purple-500 to-purple-600 text-white font-semibold rounded-xl hover:shadow-2xl hover:shadow-purple-500/50 transform hover:-translate-y-1 transition-all duration-300"
                                >
                                    Explore Events
                                </button>
                                <button
                            ...
                            <div className="glass shadow-xl dark:glass-dark rounded-3xl p-8 animate-fade-in relative z-20">
                                ...
                                <form onSubmit={handleSearch} className="space-y-6">
                                        ...
                                        <>
                                            ...
                                            <div>
                                                ...
                                                <div className="relative group">
                                                    <select
                                                        ...
                                                        className="w-full px-4 py-4 bg-gray-50 dark:bg-white/5 text-gray-900 dark:text-white border-2 border-gray-200 dark:border-white/10 rounded-xl focus:border-purple-500 focus:bg-white dark:focus:bg-white/10 focus:ring-4 focus:ring-purple-500/10 transition-all outline-none font-medium cursor-pointer hover:border-purple-500/30 dark:hover:border-white/20"
                                                        style={{
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full px-4 py-4 bg-white/5 text-white border-2 border-white/10 rounded-xl focus:border-purple-500 focus:bg-white/10 focus:ring-4 focus:ring-purple-500/10 transition-all outline-none font-medium cursor-pointer hover:border-white/20 [color-scheme:dark]"
                                                />
                                            </div>
                                        ...
                                        <>
                                            ...
                                            <div className="flex justify-center -my-3 relative z-10">
                                                <button
                                                    ...
                                                    className="p-2 bg-white dark:bg-gray-800 rounded-full shadow-lg border-2 border-gray-200 dark:border-gray-700 text-purple-500 hover:rotate-180 transition-all duration-300 hover:shadow-purple-500/20"
                                                >
                                    ...
                                    <div className="space-y-4">
                                        <button
                                            type="submit"
                                            className="w-full py-4 bg-gradient-to-r from-purple-500 to-purple-600 text-white font-bold text-lg rounded-xl hover:shadow-xl hover:shadow-purple-500/30 transform hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2 sticky bottom-4 z-50 md:static"
                                        >

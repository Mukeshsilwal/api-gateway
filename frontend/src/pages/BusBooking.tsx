...
interface Seat {
    id: string;
    status: 'available' | 'booked' | 'ladies' | 'selected' | string;
    type: 'standard' | 'sleeper' | string;
    price: number;
}
...
const BusBooking: React.FC = () => {
    ...
    const handleProceed = () => {
        ...
        // Assuming BusBookingPage or similar handles the checkout
        navigate('/bus/checkout', { state: { selectedSeats, totalPrice } });
    };

...
import { Calendar, MapPin, Clock, CreditCard, AlertCircle, CheckCircle, Ticket, Bed } from 'lucide-react';
...
const MyBookings = () => {
    ...
    const fetchBookings = async () => {
        ...
        try {
            ...
            const bookingsList = response.content || response.bookings || response || [];
            ...
            if (process.env.NODE_ENV === 'development') {
                ...
                ].filter(b => activeTab === 'upcoming' ? b.status === 'CONFIRMED' : b.status === 'COMPLETED'));
            }
        } finally {
            setLoading(false);
        }
                                            ...
                                            {booking.type === 'HOTEL' ? (
                                                ...
                                                <>
                                                    ...
                                                    <div className="flex items-center gap-1.5">
                                                        ...
                                                        <span>{new Date(booking.departureDateTime).toLocaleString()}</span>
                                                    </div>
                                                </>
                                            )}
                                        </div>

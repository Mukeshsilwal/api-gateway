...
export default function UserRegister() {
    ...
    return (
        <div className="min-h-screen flex bg-gray-50 dark:bg-slate-950 transition-colors duration-300">
            {/* Left Side - Image */}
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-purple-950">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-purple-950/90 to-indigo-950/80"></div>
            ...
            <div className="flex-1 flex items-center justify-center p-4 sm:p-8 lg:p-12 lg:w-1/2">
                <div className="w-full max-w-md space-y-8 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl shadow-xl dark:shadow-2xl border border-slate-100 dark:border-slate-800 animate-slide-up">
                    ...
                    <div className="mt-6 text-center text-sm">
                        <p className="text-gray-600 dark:text-gray-400">
                            ...
                            <Link to="/login" className="text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-bold transition-colors">
                                Sign in
                            </Link>
                        </p>
                    </div>

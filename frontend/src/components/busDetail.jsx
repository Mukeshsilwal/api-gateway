...
const BusDetail = ({ bus }) => {
  ...
  return (
    <Card hover className="overflow-hidden border-l-4 border-l-primary transition-all duration-300">
      <div className="p-5 sm:p-6">
        <div className="flex flex-col sm:flex-row gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="mt-6 flex items-center gap-4 sm:gap-8">
              <div>
                ...
                <p className="text-xs text-gray-500 font-medium">{departureDate}</p>
              </div>

              <div className="flex-1 flex flex-col items-center">
                <div className="w-full h-px bg-gray-200 relative top-3"></div>
          ...
          <div className="flex flex-col justify-between items-end sm:border-l sm:border-gray-100 sm:pl-6 min-w-[160px]">
            <div className="text-right w-full">
              <p className="text-sm text-gray-500">Starting from</p>
              <p className="text-2xl font-bold text-primary">{priceFormatted}</p>
              <p className={`text-xs font-medium mt-1 ${availableSeats < 5 ? 'text-red-500' : 'text-emerald-600'}`}>
            ...
            <div className="flex flex-col gap-3 w-full mt-6 sm:mt-0">
              ...
              <button
                ...
                className="w-full text-xs font-medium text-gray-500 hover:text-primary transition-colors flex items-center justify-center gap-1"
              >
                <Info size={14} />
        ...
        {showSeatPreview && (
          <div className="mt-6 pt-6 border-t border-gray-100 animate-slide-down">
            <div className="flex items-center justify-between mb-4">
              <h4 className="text-sm font-bold text-gray-900">Seat Layout Preview</h4>

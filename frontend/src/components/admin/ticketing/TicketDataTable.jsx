...
const TicketDataTable = ({ data, onFilterChange }) => {
    ...
    // Mock Bulk Actions
    const handleBulkAssign = (ids) => console.log('Assigning:', ids);
    const handleBulkResolve = (ids) => console.log('Resolving:', ids);
    ...
    const columns = [
        {
            ...
            label: 'Ticket ID',
            sortable: true,
            render: (value) => <span className="font-mono font-medium text-gray-900">{value}</span>
        },
        {
            key: 'subject',
            label: 'Subject',

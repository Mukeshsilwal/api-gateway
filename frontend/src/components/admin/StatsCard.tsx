...
interface StatsCardProps {
    ...
    color?: 'indigo' | 'green' | 'orange' | 'purple' | 'blue' | 'emerald' | 'amber';
    trend?: {
        direction: 'up' | 'down';
        value: number | string;
    };
...
export const StatsCard: React.FC<StatsCardProps> = ({ label, value, icon, color = 'indigo', trend, isLoading }) => {
    ...
    const colorClasses: Record<string, { bg: string; text: string; lightBg: string; icon: string }> = {
        indigo: {

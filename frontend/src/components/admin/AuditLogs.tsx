    ...
    const columns = [
        {
            ...
            label: 'Timestamp',
            sortable: true,
            render: (value: string) => <span className="text-xs text-gray-500 font-mono">{value}</span>
        },
        {
            key: 'user',
            label: 'User',
        ...
        },
        {
            key: 'details',
            label: 'Details',
            render: (value: string) => <span className="text-sm text-gray-500 truncate max-w-xs block" title={value}>{value}</span>
        },
        {
            key: 'ip',
            label: 'IP Address',
            render: (value: string) => <span className="text-xs text-gray-400 font-mono">{value}</span>
        }
    ];

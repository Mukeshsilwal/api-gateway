 ...
 * @param {Object} props
 * @param {Function} props.onSearch - Callback when search is submitted (params) => void
 * @param {Object} props.initialValues - Optional initial values
 * @param {string} props.variant - UI variant: 'compact' | 'full' (default: 'compact')
 * @param {boolean} props.showTitle - Show/hide title (default: false)
 */

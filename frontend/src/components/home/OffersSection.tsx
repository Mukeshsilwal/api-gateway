        ...
        <section className="bg-white dark:bg-black py-12 border-t border-gray-200 dark:border-white/5 transition-colors duration-300">
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between mb-8">
                    ...
                    <button className="text-orange-600 dark:text-orange-500 font-semibold hover:text-orange-500 dark:hover:text-orange-400 flex items-center gap-1 transition-colors">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {offers.map((offer, index) => (
                        <div key={index} className="group relative overflow-hidden rounded-2xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-white/10 p-6 hover:border-orange-500/30 transition-all duration-300 hover:-translate-y-1 shadow-sm dark:shadow-none">
                            {/* Gradient Background */}
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button className="text-sm font-semibold text-gray-900 dark:text-white hover:text-orange-500 transition-colors">
                                        Claim now
                                    </button>
                                </div>
                            </div>

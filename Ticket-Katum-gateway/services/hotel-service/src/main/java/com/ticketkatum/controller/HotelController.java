...
public class HotelController {
    ...
    @Operation(summary = "Get all hotels", description = "Retrieves all hotels with optional filters")
    @GetMapping
    public ResponseEntity<Response<List<HotelDTO>>> getAllHotels(
        ...
        // Apply filters (TODO: Move to service layer with database-level filtering)
        if (city != null) {
